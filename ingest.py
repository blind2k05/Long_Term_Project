...
def main():
    ...
    # === UPDATE: Menggunakan os.walk untuk menyisir SEMUA folder dan sub-folder ===
    for root, dirs, files in os.walk(config.RAW_DIR):
        # Tentukan kategori berdasarkan nama folder tempat file tersebut berada
        category = os.path.basename(root)
        if category == "raw": 
            category = "General_Uploads" # Nama kategori jika file ditaruh langsung di luar
